...
#             3
#
# Find the longest number of steps away from the pipe
# a.k.a. the height of the tree

visited_nodes = [(int, int)]
...
def solve(file: str) -> int:
    ...
    root = Node('F', x, y) # TODO: Determine type at runtime
    buildTree(data, root)
...
def buildTree(data: list[str], n: Node) -> int:
    ...
    # TODO: This builds tree from preorder traversal
    buildTree(data, n.left)
    buildTree(data, n.right)
